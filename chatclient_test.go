...
func TestClient_emoteHighlight(t *testing.T) {
	data := [][]string{
		...
		{`<img src="/emotes/twitch/zorchenhimer/zorcheWhat.png" height="36px" title="zorcheWhat">`, `<img src="/emotes/twitch/zorchenhimer/zorcheWhat.png" height="36px" title="zorcheWhat">`},
		{`zorchenhimer <img src="/emotes/twitch/zorchenhimer/zorcheWhat.png" height="36px" title="zorcheWhat">`, `<span class="mention">zorchenhimer</span> <img src="/emotes/twitch/zorchenhimer/zorcheWhat.png" height="36px" title="zorcheWhat">`},
	}
